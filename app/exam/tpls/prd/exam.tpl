...
<div class="container-fluid" id="datacontent">
	<div class="row-fluid">
		<div class="main">
			<div class="box itembox" style="display:none;margin-bottom:0px;">
				<div class="col-xs-12">
					<ol class="breadcrumb">
					  <li><a href="index.php">首页</a></li>
					  <li><a href="index.php?exam-app">考试2</a></li>
			...
			<div class="box itembox">
                ...
                {x2;if:$data['currentbasic']['basicexam']['opentime']['start'] && $data['currentbasic']['basicexam']['opentime']['end']}
                	{x2;if:$data['currentbasic']['basicexam']['opentime']['start'] <= TIME && $data['currentbasic']['basicexam']['opentime']['end'] >= TIME}
	                	...
	                	<div class="box itembox" style="padding-top:20px;">
							<div class="col-xs-3">
								<a href="index.php?exam-prd-recover" class="thumbnail pull-left ajax">
									<img src="app/core/styles/img/item.jpg" alt="" width="100%">
								</a>
							</div>
							<div class="col-xs-9">
								<a href="index.php?exam-prd-recover" class="ajax"><h4 class="title">意外续考</h4></a>
								...
								<p>
									<span class="pull-right">
										<a href="index.php?exam-prd-recover" class="btn btn-primary ajax">继续考试</a>&nbsp;&nbsp;
										<a href="index.php?exam-prd-recover-clearexamsession" class="btn btn-danger confirm" msg="放弃考试会删除此次考试会话并不能恢复，确认要放弃吗？">放弃考试</a>
                		...
                		{x2;if:$data['currentbasic']['basicexam']['selectrule']}
							...
							<div class="text-center"><a class="btn" href="javascript:;">您的考试次数已经用完</a>&nbsp;&nbsp;<a href="index.php?user-prd-logout" class="btn btn-info ajax">退出系统</a></div>
							{x2;else}
							<div class="text-center">
								<a action-before="clearStorage" class="ajax btn btn-primary" href="index.php?exam-prd-exam-selectquestions&examid={x2;v:exam['examid']}" action-before="clearStorage">开始考试</a>
								&nbsp;&nbsp;<a href="index.php?user-prd-logout" class="btn btn-info ajax">退出系统</a>
							</div>
							{x2;endif}
                		{x2;else}
							...
							<div class="col-xs-3" style="width:20%">
								...
								{x2;else}
									<a action-before="clearStorage" href="index.php?exam-prd-exam-selectquestions&examid={x2;v:exam['examid']}" class="thumbnail ajax" style="position:relative;">
								{x2;endif}
									<img src="app/core/styles/img/item.jpg" alt="" width="100%">
								</a>
                ...
                {x2;else}
                	...
                	{x2;if:$data['currentbasic']['basicexam']['selectrule']}
						...
						<div class="text-center"><a class="btn" href="javascript:;">您的考试次数已经用完</a>&nbsp;&nbsp;<a href="index.php?user-prd-logout" class="btn btn-info ajax">退出系统</a></div>
						{x2;else}
						<div class="text-center"><a class="ajax btn btn-primary" action-before="clearStorage" href="index.php?exam-prd-exam-selectquestions&examid={x2;v:exam['examid']}" action-before="clearStorage">开始考试</a>&nbsp;&nbsp;<a href="index.php?user-prd-logout" class="btn btn-info ajax">退出系统</a></div>
						{x2;endif}
            		{x2;else}
            			{x2;tree:$exams['data'],exam,eid}
						<div class="col-xs-3" style="width:20%">
